...
export default function PostCard({ post }) {
  ...
  return (
    ...
    <div className="bg-white rounded-xl shadow-lg border border-gray-300 flex flex-col h-full overflow-hidden">
      {/* 게시물 헤더 */}
      <div className="p-5 border-b border-gray-200">
        ...
        <div className="flex justify-between items-start mb-2">
          ...
          <div className="flex-1 mr-4">
            <h3 className="text-xs font-semibold text-gray-800 mb-0.5 line-clamp-2 leading-snug">
              {" "}
              {/* 제목 스타일 변경 */}
      ...
      <div className="p-4 bg-gray-50 border-t border-gray-200 mt-auto">
        ...
        {post.band_post_url ? (
          <a
            ...
            className="w-full inline-flex items-center justify-center gap-1.5 px-4 py-2 bg-gray-700 text-white text-xs font-semibold rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500" // 버튼 스타일 변경
          >
