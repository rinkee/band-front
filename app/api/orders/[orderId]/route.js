...
export async function PATCH(request, { params }) {
  try {
    ...
    const { product_id, product_name, quantity } = await request.json();

    console.log('Order update - orderId:', orderId, 'data:', { product_id, product_name, quantity });
    ...
    // 주문 정보 업데이트 - product_id도 함께 업데이트
    const updateData = {
