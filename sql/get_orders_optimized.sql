...
AS $function$
  ...
  BEGIN
    ...
    v_search_comment := p_search_type = 'comment';
    ...
    WHERE o.user_id = p_user_id
      ...
      AND (
        p_search IS NULL
        OR (
          (v_search_customer AND o.customer_name ILIKE v_search_pattern)
          OR (v_search_comment AND o.comment ILIKE v_search_pattern)
          OR (
            v_search_product AND (
